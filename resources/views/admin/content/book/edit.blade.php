            ...
            <div class="col-md-10">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label for="inputBooknumber" class="col-sm-2 control-label">编号</label>
                            <div class="col-sm-7">
                                {!! Form::text('booknum', $book->booknum, ['id' => 'inputBooknumber', 'class' => 'form-control','placeholder'=>'编号']) !!}
                                <font color="red">{{ $errors->first('booknum') }}</font>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                ...
                                @if(!empty($book->pic))
                                    <div class="row">
                                        <div class="col-sm-12 ">
                                            <img id="imgPic" src="{{ asset('/uploads').'/'.$book->pic }}"
